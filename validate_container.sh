...
test_examples() {
    ...
    docker exec -w /home/cudaq ${container_name} bash -c "mkdir -p test_data/chromobius"
    docker exec -w /home/cudaq/test_data/chromobius ${container_name} bash -c "wget -O basic_reference.dem https://raw.githubusercontent.com/NVIDIA/cudaqx/refs/heads/main/libs/qec/test_data/chromobius/basic_reference.dem"
    docker exec -w /home/cudaq/test_data/chromobius ${container_name} bash -c "wget -O basic_reference.tsv https://raw.githubusercontent.com/NVIDIA/cudaqx/refs/heads/main/libs/qec/test_data/chromobius/basic_reference.tsv"
    docker exec -w /home/cudaq/test_data/chromobius ${container_name} bash -c "pwd && ls -lh"
